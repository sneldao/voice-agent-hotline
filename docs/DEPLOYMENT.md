...
| Target | URL | Notes |
|---|---|---|
| Vercel | `your-claflin-app.vercel.app` | Auto-deploys from `main`; serverless API routes |
...
CORS, no preflight round-trips, and ad-blockers stop flagging API calls.
...
1. Verify brokers: `GET /api/agents`
