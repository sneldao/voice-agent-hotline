...
| [Architecture](./AGENTIC_ARCHITECTURE.md) | Intent-based architecture, ERC-4337, TEEs |
...
| Document | Purpose |
|----------|---------|
| [Voice Pipeline](../lib/voice/README.md) | STT → LLM → TTS pipeline |
| [Submission](./submission/README.md) | Hackathon submission (Celo V2) |
