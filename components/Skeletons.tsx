...
export function AgentCardSkeleton() {
  return (
    <div className="bg-gray-900/50 border border-gray-800/50 rounded-2xl p-4 animate-pulse">
...
export function CallHistorySkeleton() {
  return (
    <div className="space-y-3">
      {[1, 2, 3].map((i) => (
        <div key={i} className="bg-gray-900/50 border border-gray-800/50 rounded-xl p-4 animate-pulse">
...
export function ProfileSkeleton() {
  return (
    <div className="space-y-4">
      {/* Balance card */}
      <div className="bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border border-cyan-500/20 rounded-2xl p-6 animate-pulse">
